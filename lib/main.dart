...
import 'package:bookly/Features/home/presentation/manager/newest_books_cubit%20copy/newest_books_cubit.dart';
        ...
        BlocProvider(
          create: (context) {
            return FeaturedBooksCubit(FetchFeaturedBooksUseCase(
                homeRepo: getItLocator.
                get<HomeRepoImpl>()))
                //trigger request , cascade operator
                ..fetchFeaturedBooks();
          },
        ),
        BlocProvider(
          create: (context) {
            return NewestBooksCubit(FetchNewestBooksUseCase(
                homeRepo: getItLocator
                .get<HomeRepoImpl>()))..fetchNewestBooks();
          },
        )
      ],
